  ...
  return (
    <div className="animate-in fade-in duration-300">
      <header className="flex justify-between items-center p-4 sticky top-0 bg-white/95 dark:bg-slate-950/95 backdrop-blur-sm z-20 transition-colors duration-300">
          ...
          <button className="text-slate-700 dark:text-slate-300 relative p-1 bg-slate-50 dark:bg-slate-900 rounded-full w-8 h-8 flex items-center justify-center border border-[#d8dfe7] dark:border-slate-800/80 cursor-pointer">
      ...
      <div className="flex gap-3 px-4 py-3">
          <div className="bg-blue-50/50 dark:bg-blue-950/20 flex-1 rounded-[10px] p-3 flex justify-between items-center border border-[#c8d3e3] dark:border-blue-900/30 shadow-sm transition-colors duration-300">
              <div>
                  <h3 className="text-[13px] leading-[16.5px] mt-[-3px] mb-0 font-black text-slate-800 dark:text-slate-200">Daily Goal</h3>
          ...
          <div className="bg-white dark:bg-slate-950 flex-1 rounded-[10px] p-3 shadow-sm border border-[#d8dfe7] dark:border-slate-800/80 flex flex-col justify-between transition-colors duration-300">
              <div className="flex justify-between items-start">
                  <div>
                      <h3 className="text-[14px] leading-[15.5px] font-black text-slate-800 dark:text-slate-200">Study Streak</h3>
                      <p className="text-xs font-black text-slate-900 dark:text-white mt-1">{userData.studyStreak} <span className="text-[10px] font-medium text-slate-500 dark:text-slate-400">Days</span></p>
                  </div>
      ...
      <div className="px-4 py-2">
          <div className="flex justify-between items-center mb-3">
              <h3 className="text-[13px] font-[Georgia] font-black text-slate-900 dark:text-white uppercase tracking-wider">Quick Access</h3>
          </div>
          <div className="grid grid-cols-4 gap-3">
              <button onClick={() => navigate('study-plan')} className="flex flex-col items-center gap-1.5 group cursor-pointer">
                  <div className="w-12 h-12 bg-emerald-50 dark:bg-emerald-950/30 text-emerald-600 dark:text-emerald-400 border border-[#c8e1d9] rounded-[10px] flex justify-center items-center group-hover:scale-105 transition"><i className="fa-regular fa-calendar-check text-lg"></i></div>
                  <span className="text-xs text-slate-700 dark:text-slate-300 font-bold">Study Plan</span>
              </button>
              <button onClick={() => navigate('test')} className="flex flex-col items-center gap-1.5 group cursor-pointer">
                  <div className="w-12 h-12 bg-blue-50 dark:bg-blue-950/30 text-blue-600 dark:text-blue-400 border border-[#ccd8f2] rounded-[10px] flex justify-center items-center group-hover:scale-105 transition"><i className="fa-solid fa-laptop-code text-lg"></i></div>
                  <span className="text-xs text-slate-700 dark:text-slate-300 font-bold">Mock Test</span>
              </button>
              <button onClick={() => navigate('test')} className="flex flex-col items-center gap-1.5 group cursor-pointer">
                  <div className="w-12 h-12 bg-purple-50 dark:bg-purple-950/30 text-purple-600 dark:text-purple-400 border border-[#e5d5f1] rounded-[10px] flex justify-center items-center group-hover:scale-105 transition"><i className="fa-regular fa-file-lines text-lg"></i></div>
                  <span className="text-xs text-slate-700 dark:text-slate-300 font-bold">Past Papers</span>
              </button>
              <button onClick={() => navigate('study')} className="flex flex-col items-center gap-1.5 group cursor-pointer">
                  <div className="w-12 h-12 bg-orange-50 dark:bg-orange-950/30 text-orange-500 dark:text-orange-400 border border-[#eeded3] rounded-[10px] flex justify-center items-center group-hover:scale-105 transition"><i className="fa-regular fa-bookmark text-lg"></i></div>
                  <span className="text-xs text-slate-700 dark:text-slate-300 font-bold">Notes</span>
              </button>
          </div>
      </div>
      ...
      <div className="px-4 py-4">
          <div className="flex justify-between items-center mb-3">
              <h3 className="text-[13px] font-[Georgia] font-black text-slate-900 dark:text-white uppercase tracking-wider">Subjects</h3>
              <button onClick={() => navigate('all-subjects')} className="text-xs font-[Georgia] text-blue-600 dark:text-blue-400 font-black cursor-pointer">See All</button>
          </div>
          <div className="grid grid-cols-4 gap-2.5">
              <button onClick={() => navigate('study')} className="bg-[#eefcf2] dark:bg-emerald-950/20 rounded-[10px] p-2 flex flex-col items-center border border-[#c4ded1] dark:border-emerald-900/30 shadow-sm cursor-pointer hover:scale-[1.02] active:scale-[0.98] transition">
                  ...
                  <span className="text-xs font-black text-slate-900 dark:text-slate-200 mt-2">Math</span>
              </button>
              ...
              <button onClick={() => navigate('study')} className="bg-[#f5f3ff] dark:bg-purple-950/20 rounded-[10px] p-2 flex flex-col items-center border border-[#ddd6fe] dark:border-purple-900/30 shadow-sm cursor-pointer hover:scale-[1.02] active:scale-[0.98] transition">
                  ...
                  <span className="text-xs font-black text-slate-900 dark:text-slate-200 mt-2">English</span>
              </button>
              ...
              <button onClick={() => navigate('study')} className="bg-[#fffbeb] dark:bg-amber-950/20 rounded-[10px] p-2 flex flex-col items-center border border-[#ded4aa] dark:border-amber-900/30 shadow-sm cursor-pointer hover:scale-[1.02] active:scale-[0.98] transition">
                  ...
                  <span className="text-xs font-black text-slate-900 dark:text-slate-200 mt-2">Bangla</span>
              </button>
              ...
              <button onClick={() => navigate('study')} className="bg-[#eff6ff] dark:bg-blue-950/20 rounded-[10px] p-2 flex flex-col items-center border border-[#cad9ee] dark:border-blue-900/30 shadow-sm cursor-pointer hover:scale-[1.02] active:scale-[0.98] transition">
                  ...
                  <span className="text-xs font-black text-slate-900 dark:text-slate-200 mt-2">GK</span>
              </button>
          </div>
      </div>
      
      {/* Interactive Infographics Section */}
      <div className="px-4 py-2 border-t border-[#d8dfe7] dark:border-slate-800/80 mt-2 pt-4 pb-4">
          <div className="mb-3">
              <span className="text-[9px] font-[Arial] ml-[1px] font-black tracking-wider text-emerald-600 dark:text-emerald-400 uppercase">visual smart study</span>
              <h3 className="text-[14px] font-[Georgia] font-black text-slate-900 dark:text-white leading-tight">Interactive Infographics</h3>
          </div>
          ...
          <div className="space-y-3">
              ...
              <div 
                  ...
                  className="bg-white dark:bg-slate-950 p-3.5 rounded-[10px] border border-[#b9cee3] hover:border-emerald-200 dark:hover:border-emerald-800 shadow-sm hover:shadow transition cursor-pointer flex justify-between items-center group"
              >
                  <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-[#eef4f1] text-emerald-600 dark:text-emerald-400 rounded-[10px] border border-[#00bb88] flex items-center justify-center text-base group-hover:scale-105 transition">
                          <i className="fa-solid fa-leaf"></i>
                      </div>
                      <div>
                          <h4 className="text-[12px] font-[Georgia] font-black text-slate-950 dark:text-white leading-tight mb-0.5">Photosynthesis Science Infographic</h4>
                          <p className="text-[10px] text-slate-500 dark:text-slate-400 font-bold">Step-by-step leaf food synthesis visualizer</p>
                      </div>
                  </div>
              ...
              <div 
                  ...
                  className="bg-white dark:bg-slate-950 p-3.5 rounded-[10px] border border-[#bbc6d3] hover:border-blue-200 dark:hover:border-blue-800 shadow-sm hover:shadow transition cursor-pointer flex justify-between items-center group"
              >
                  <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-blue-50 dark:bg-blue-950/30 text-blue-600 dark:text-blue-400 rounded-[10px] border border-[#bbc6d3] flex items-center justify-center text-base group-hover:scale-105 transition">
                          <i className="fa-solid fa-map-location-dot"></i>
                      </div>
                      <div>
                          <h4 className="text-[12px] font-[Georgia] font-black text-slate-950 dark:text-white leading-tight mb-0.5">Interactive Bangladesh Map</h4>
                          <p className="text-[10px] text-slate-500 dark:text-slate-400 font-bold">Explore divisions, districts & landmarks</p>
                      </div>
                  </div>
