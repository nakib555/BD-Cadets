...
export default function StudyPlan() {
  ...
  return (
    <div className="bg-slate-50/50 dark:bg-slate-900 min-h-full pb-6 transition-colors duration-300 animate-in fade-in duration-300">
      ...
      <div className="bg-white dark:bg-slate-950 px-4 py-3 border-b border-[#d8dfe7] dark:border-slate-800/80 flex justify-between transition-colors duration-300">
      ...
      <div className="p-4 relative">
          ...
          <div className="flex gap-4 mb-6 relative">
              ...
              <div className="flex-1 bg-white dark:bg-slate-950 p-3 rounded-[10px] border border-[#d8dfe7] dark:border-slate-800/80 shadow-sm flex justify-between items-center transition-colors duration-300">
                  <div>
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 font-semibold"><i className="fa-regular fa-clock mr-1 text-[12px]"></i>06:00 AM - 07:00 AM</span>
                      <h4 className="text-[14px] font-[Georgia] font-black text-slate-900 dark:text-white mt-1">Mathematics</h4>
                      <p className="text-[10px] text-slate-500 dark:text-slate-400">Algebraic Expressions</p>
                  </div>
                  <span className="text-[10px] text-emerald-600 dark:text-emerald-400 font-bold bg-emerald-50 dark:bg-emerald-950/40 px-2 py-1 rounded-full"><i className="fa-solid fa-circle-check mr-1 text-[12px]"></i>Completed</span>
              </div>
          </div>
          ...
          <div className="flex gap-4 mb-6 relative">
              ...
              <div className="flex-1 bg-white dark:bg-slate-950 p-3 rounded-[10px] border border-[#c8d3e3] dark:border-blue-900/30 shadow-sm shadow-blue-50/50 dark:shadow-none flex justify-between items-center ring-1 ring-blue-50/50 dark:ring-0 transition-colors duration-300">
                  <div>
                      <span className="text-[10px] text-blue-500 dark:text-blue-400 font-semibold"><i className="fa-regular fa-clock mr-1 text-[12px]"></i>07:30 AM - 08:30 AM</span>
                      <h4 className="text-[14px] font-[Georgia] font-black text-slate-900 dark:text-white mt-1">English</h4>
                      <p className="text-[10px] text-slate-500 dark:text-slate-400">Vocabulary & Grammar</p>
                  </div>
                  <span className="text-[10px] text-blue-600 dark:text-blue-400 font-bold bg-blue-50 dark:bg-blue-950/40 px-2 py-1 rounded-full"><i className="fa-solid fa-arrows-rotate mr-1 text-[12px]"></i>In Progress</span>
              </div>
          </div>
          ...
          <div className="flex gap-4 mb-6 relative">
              ...
              <div className="flex-1 bg-white dark:bg-slate-950 p-3 rounded-[10px] border border-[#d8dfe7] dark:border-slate-800/80 shadow-sm flex justify-between items-center opacity-70 transition-colors duration-300">
                  <div>
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 font-semibold"><i className="fa-regular fa-clock mr-1 text-[12px]"></i>09:00 AM - 10:00 AM</span>
                      <h4 className="text-[14px] font-[Georgia] font-black text-slate-900 dark:text-white mt-1">General Knowledge</h4>
                      <p className="text-[10px] text-slate-500 dark:text-slate-400">Bangladesh Affairs</p>
                  </div>
                  <span className="text-[10px] text-slate-500 dark:text-slate-400 font-bold"><i className="fa-regular fa-circle mr-1 text-[12px]"></i>Upcoming</span>
              </div>
          </div>
      </div>
