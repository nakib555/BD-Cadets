...
export default function Progress() {
  ...
  return (
    <div className="bg-slate-50/50 dark:bg-slate-900 min-h-full pb-6 transition-colors duration-300 animate-in fade-in duration-300">
      ...
      <div className="bg-white dark:bg-slate-950 flex px-4 text-[10px] font-black text-slate-400 dark:text-slate-500 text-center sticky top-[60px] z-10 shadow-sm border-b border-[#d8dfe7]/50 dark:border-slate-800/40 transition-colors duration-300">
      ...
      <div className="p-4 space-y-4">
          <div className="bg-white dark:bg-slate-950 p-4 rounded-[10px] shadow-sm border border-[#d8dfe7] dark:border-slate-800/80 flex items-center justify-between transition-colors duration-300">
              ...
              <div className="flex-1 ml-6 flex flex-col relative h-[80px]">
                  <div className="absolute right-0 top-0 text-[10px] font-black text-slate-500 dark:text-slate-400 bg-orange-50 dark:bg-orange-950/40 text-orange-600 dark:text-orange-400 px-2.5 py-1 rounded-full border border-[#f3dec3]">
                      <i className="fa-solid fa-fire mr-1 text-[12px]"></i>Great job!
                  </div>
          ...
          <div className="bg-white dark:bg-slate-950 p-4 rounded-[10px] shadow-sm border border-[#d8dfe7] dark:border-slate-800/80 grid grid-cols-4 divide-x divide-slate-100 dark:divide-slate-800/80 text-center transition-colors duration-300">
              <div><p className="text-[10px] font-bold text-slate-400 dark:text-slate-500 mb-1 uppercase tracking-wider">Tests Taken</p><p className="text-[14px] font-[Georgia] font-black text-slate-900 dark:text-white">{userData.testsTaken}</p></div>
              <div><p className="text-[10px] font-bold text-slate-400 dark:text-slate-500 mb-1 uppercase tracking-wider">Avg. Score</p><p className="text-[14px] font-[Georgia] font-black text-slate-900 dark:text-white">{userData.avgScore}%</p></div>
              <div><p className="text-[10px] font-bold text-slate-400 dark:text-slate-500 mb-1 uppercase tracking-wider">Best Score</p><p className="text-[14px] font-[Georgia] font-black text-slate-900 dark:text-white">{userData.bestScore}%</p></div>
              <div><p className="text-[10px] font-bold text-slate-400 dark:text-slate-500 mb-1 uppercase tracking-wider">Streak</p><p className="text-[14px] font-[Georgia] font-black text-slate-900 dark:text-white">{userData.studyStreak} <span className="text-[10px] text-slate-500 dark:text-slate-400 font-medium">Days</span></p></div>
          </div>

          <div className="bg-white dark:bg-slate-950 p-5 rounded-[10px] shadow-sm border border-[#d8dfe7] dark:border-slate-800/80 transition-colors duration-300">
              <h3 className="text-[13px] font-[Georgia] font-black text-slate-800 dark:text-white uppercase tracking-wider mb-5">Subject Wise Performance</h3>
