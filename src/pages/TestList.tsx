...
export default function TestList() {
  ...
  const tests = [
    { title: 'Cadet College Admission Test 2023', type: 'Full Mock Test', qns: 100, time: '120 min', taken: '12.5K', icon: 'fa-solid fa-trophy', bg: 'bg-orange-50 dark:bg-orange-950/30', color: 'text-orange-500 dark:text-orange-400' },
    { title: 'Previous Year Math Test 2022', type: 'Subject Test', qns: 50, time: '60 min', taken: '8.7K', icon: 'fa-solid fa-star', bg: 'bg-purple-50 dark:bg-purple-950/30', color: 'text-purple-500 dark:text-purple-400' },
    { title: 'General Knowledge Full Mock Test', type: 'Mock Test', qns: 100, time: '120 min', taken: '6.3K', icon: 'fa-solid fa-crown', bg: 'bg-blue-50 dark:bg-blue-950/30', color: 'text-blue-500 dark:text-blue-400' },
  ];
